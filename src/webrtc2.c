...
static const gchar *peer_id = "219";
...
start_pipeline (void)
{
    ...
    */
    ...
    pipe1 =
            gst_parse_launch ("webrtcbin stun-server=stun://stun.l.google.com:19302 name=sendrecv ! rtpvp8depay ! vp8dec ! videoconvert ! x264enc ! flvmux ! filesink location=/home/sham/tmp/xyz.flv", &error);
    if (error) {
    ...
    g_signal_emit_by_name (webrtc1, "create-data-channel", "channel", NULL,
                           &send_channel);
    GstCaps *caps = gst_caps_from_string(RTP_CAPS_VP8"96");
    GstWebRTCRTPTransceiver *trans = NULL;
    g_signal_emit_by_name( webrtc1, "add-transceiver", GST_WEBRTC_RTP_TRANSCEIVER_DIRECTION_RECVONLY, caps, &trans );
//    g_signal_emit_by_name( webrtc1, "add-transceiver", GST_WEBRTC_RTP_TRANSCEIVER_DIRECTION_INACTIVE, gst_caps_from_string(RTP_CAPS_OPUS "96"), &trans );
